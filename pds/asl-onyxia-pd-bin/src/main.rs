...
#[no_mangle]
#[link_section = ".rodata"]
pub static microkit_name: [u8; 10] = *b"Onyxia-PD\0";
...
pub extern "C" fn init() {
    let mut w = Uart;
    let _ = core::writeln!(w, "[Onyxia-PD] seL4 boot — proof=0x{:X}", SOVEREIGN_PROOF);
    assert_eq!(SOVEREIGN_PROOF, 0x4153);
    let _ = core::writeln!(w, "[Onyxia-PD] init complete");
}
