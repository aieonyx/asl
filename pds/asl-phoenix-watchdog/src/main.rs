...
#[no_mangle]
#[link_section = ".rodata"]
pub static microkit_name: [u8; 17] = *b"Phoenix-Watchdog\0";
...
pub extern "C" fn init() {
    let mut w = Uart;
    let _ = core::writeln!(w, "[Phoenix-Watchdog] seL4 boot — proof=0x{:X}", SOVEREIGN_PROOF);
    assert_eq!(SOVEREIGN_PROOF, 0x4153);
    let _ = core::writeln!(w, "[Phoenix-Watchdog] init complete");
}
